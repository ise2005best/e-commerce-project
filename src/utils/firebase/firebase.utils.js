...
import { getAuth, signInWithPopup, GoogleAuthProvider, createUserWithEmailAndPassword, signInWithRedirect, sendEmailVerification } from 'firebase/auth';
...
// this allows you to sign into your google account with a pop up not using it 
...
signInWithRedirect(googleAuth, proivder);
